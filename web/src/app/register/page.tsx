    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-[var(--brand-dark)] to-[var(--brand-medium)] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-md w-full">
          <div className="bg-white rounded-lg shadow-xl p-8 text-center border-2 border-[var(--brand-secondary)]">
            <div className="text-6xl mb-4">✅</div>
            <h2 className="text-2xl font-bold text-[var(--brand-dark)] mb-4">Registration Successful!</h2>
            <p className="text-[var(--brand-medium)] mb-6 leading-relaxed">
              Your account has been created successfully. Please wait for admin approval before you can sign in.
            </p>
            <div className="space-y-3">
              <Link
                href="/login"
                className="block w-full py-3 px-4 bg-[var(--brand)] text-[var(--color-on-brand)] font-medium rounded-lg hover:bg-[var(--brand-medium)] transition-colors shadow-md"
              >
                Go to Sign In
              </Link>
              <Link
                href="/"
                className="block w-full py-3 px-4 bg-[var(--brand-accent)] text-[var(--color-on-brand)] font-medium rounded-lg hover:bg-[var(--brand-secondary)] transition-colors shadow-md"
              >
                Back to Home
              </Link>
            </div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[var(--brand-dark)] to-[var(--brand-medium)] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center bg-[var(--brand-accent-light)] rounded-lg p-4 border border-[var(--brand-secondary)]">
          <div className="text-sm text-[var(--brand-dark)]">
            <p className="font-medium">📋 <strong>Important:</strong> Your account will need to be approved by an administrator before you can access the system.</p>
          </div>
        </div>
      </div>
    </div>
