...
function getDisplayTextForChoiceToken(originalToken: string, selectedChoice?: string) {
    ...
    >
      <div className="text-center w-full relative z-10">
        {(element === '+/-' || element === '×/÷' || element === '?') &&
         sourceType === 'answer' && choiceSelection
          ? getDisplayTextForChoiceToken(element, choiceSelection)
          : element
        }
      </div>
