      ...
      {(!collapsible || showOptions) && (
        <>
          ...
          {typeof numQuestions === 'number' && onNumQuestionsChange && (
            <div className={`mb-6 ${variant === 'display' ? 'bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-xl p-4' : 'bg-blue-50 border border-blue-200 rounded-xl p-4'}`}>
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2">
                  <button
                    type="button"
                    className="w-10 h-10 rounded-full bg-blue-200 hover:bg-blue-300 text-blue-900 font-bold text-lg disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 flex items-center justify-center shadow-sm hover:shadow-md"
                  ...
                  <InputNumberBox
                    ...
                    min={1}
                    max={100}
                    className="w-20 h-10 text-center px-2 py-2 border-2 border-blue-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-200 focus:border-blue-400 text-lg font-bold bg-white text-blue-900 appearance-none [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none shadow-sm"
                  />
                  <button
                    type="button"
                    className="w-10 h-10 rounded-full bg-blue-200 hover:bg-blue-300 text-blue-900 font-bold text-lg disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 flex items-center justify-center shadow-sm hover:shadow-md"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            <div className="bg-white border border-gray-200 rounded-xl shadow-sm p-4 col-span-1 lg:col-span-2 min-w-[140px] transition-all duration-200 hover:bg-gray-50 hover:shadow-md">
            ...
            <div className="col-span-1 lg:col-span-2">
              <div className={
                options.operatorMode === 'random'
                  ? "bg-white border border-gray-200 rounded-xl shadow-sm p-4 min-w-[140px] transition-all duration-200 hover:bg-gray-50 hover:shadow-md"
                  : "bg-gray-50 border border-gray-300 rounded-xl shadow-sm p-4 min-w-[140px] transition-all duration-200 hover:bg-gray-100 hover:shadow-md space-y-3"
              }>
            ...
            <div className="bg-white border border-gray-200 rounded-xl shadow-sm p-4 min-w-[140px] transition-all duration-200 hover:bg-gray-50 hover:shadow-md">
              <label className="block text-sm font-medium text-black mb-2">
              ...
              <div className="flex items-center justify-center gap-2">
                <button
                  type="button"
                  className="w-10 h-10 rounded-full bg-orange-200 hover:bg-orange-300 text-orange-900 font-bold text-lg disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 flex items-center justify-center shadow-sm hover:shadow-md"
                ...
                <InputNumberBox
                  ...
                  className="w-16 h-10 text-center px-2 py-2 border-2 border-orange-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-200 focus:border-orange-400 text-lg font-bold bg-white text-green-900 appearance-none [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none shadow-sm"
                />
                <button
                  type="button"
                  className="w-10 h-10 rounded-full bg-orange-200 hover:bg-orange-300 text-orange-900 font-bold text-lg disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 flex items-center justify-center shadow-sm hover:shadow-md"
            ...
            <div className="bg-gray-50 border border-gray-300 rounded-xl shadow-sm p-4 min-w-[140px] transition-all duration-200 hover:bg-gray-100 hover:shadow-md">
              <label className="block text-sm font-medium text-black mb-2">
                Number of heavy numbers
                <span className="block text-xs text-gray-600 mt-1 font-normal">
              ...
              <div className="flex items-center justify-center gap-2">
                <button
                  type="button"
                  className="w-10 h-10 rounded-full bg-emerald-200 hover:bg-emerald-300 text-emerald-700 font-bold text-lg disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 flex items-center justify-center shadow-sm hover:shadow-md"
                ...
                <InputNumberBox
                  ...
                  className="w-16 h-10 text-center px-2 py-2 border-2 border-emerald-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-200 focus:border-emerald-400 text-lg font-bold bg-white text-green-900 appearance-none [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none shadow-sm"
                />
                <button
                  type="button"
                  className="w-10 h-10 rounded-full bg-emerald-200 hover:bg-emerald-300 text-emerald-700 font-bold text-lg disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 flex items-center justify-center shadow-sm hover:shadow-md"
            ...
            <div className="bg-white border border-gray-200 rounded-xl shadow-sm p-4 min-w-[140px] transition-all duration-200 hover:bg-gray-50 hover:shadow-md">
              ...
              <div className="flex items-center justify-center gap-2">
                ...
                <InputNumberBox
                  ...
                  className="w-16 h-10 text-center px-2 py-2 border-2 border-yellow-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-200 focus:border-yellow-400 text-lg font-bold bg-white text-green-900 appearance-none [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none shadow-sm"
                />
                <button
                  type="button"
                  className="w-10 h-10 rounded-full bg-yellow-200 hover:bg-yellow-300 text-yellow-900 font-bold text-lg disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 flex items-center justify-center shadow-sm hover:shadow-md"
            ...
            {/* Number of zeros */}
            <div className="bg-gray-50 border border-gray-200 rounded-xl shadow-sm p-4 min-w-[140px] transition-all duration-200 hover:bg-gray-100 hover:shadow-md">
              <label className="block text-sm font-medium text-black mb-2">
                Number of zeros
                <span className="block text-xs text-gray-600 mt-1 font-normal">
      ...
      {show === 'random' ? (
        ...
        <>
          <div className="grid grid-cols-2 gap-3 mt-2">
            {/* Plus + */}
            <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-4 border-2 border-green-200 hover:border-green-300 hover:shadow-md transition-all duration-200 group">
              <div className="flex items-center justify-between mb-3">
                ...
                <label className="relative inline-flex items-center cursor-pointer">
                  ...
                  <span className="ml-3 text-xs font-medium text-green-700">Fixed</span>
                </label>
              </div>
              <div className="flex items-center gap-2">
                <button
            ...
            {/* Minus - */}
            <div className="bg-gradient-to-br from-red-50 to-red-100 rounded-xl p-4 border-2 border-red-200 hover:border-red-300 hover:shadow-md transition-all duration-200 group">
              <div className="flex items-center justify-between mb-3">
                ...
                <label className="relative inline-flex items-center cursor-pointer">
                  ...
                  <div className="absolute left-1 top-1 w-4 h-4 bg-white rounded-full shadow peer-checked:translate-x-4 transition-transform duration-200"></div>
                  <span className="ml-3 text-xs font-medium text-red-700">Fixed</span>
                </label>
              </div>
              <div className="flex items-center gap-2">
                <button
            ...
            {/* Multiply × */}
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-4 border-2 border-blue-200 hover:border-blue-300 hover:shadow-md transition-all duration-200 group">
              <div className="flex items-center justify-between mb-3">
                ...
                <label className="relative inline-flex items-center cursor-pointer">
                  ...
                  <div className="absolute left-1 top-1 w-4 h-4 bg-white rounded-full shadow peer-checked:translate-x-4 transition-transform duration-200"></div>
                  <span className="ml-3 text-xs font-medium text-blue-700">Fixed</span>
                </label>
              </div>
              <div className="flex items-center gap-2">
                <button
            ...
            {/* Divide ÷ */}
            <div className="bg-gradient-to-br from-orange-50 to-orange-100 rounded-xl p-4 border-2 border-orange-200 hover:border-orange-300 hover:shadow-md transition-all duration-200 group">
              <div className="flex items-center justify-between mb-3">
                ...
                <label className="relative inline-flex items-center cursor-pointer">
                  ...
                  <div className="absolute left-1 top-1 w-4 h-4 bg-white rounded-full shadow peer-checked:translate-x-4 transition-transform duration-200"></div>
                  <span className="ml-3 text-xs font-medium text-orange-700">Fixed</span>
                </label>
              </div>
              <div className="flex items-center gap-2">
                <button
