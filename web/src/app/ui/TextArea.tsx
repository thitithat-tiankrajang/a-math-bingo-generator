...
export default function TextArea({
  ...
  const baseClasses = 'w-full px-4 py-3 border-2 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-300 ease-in-out bg-white shadow-sm hover:shadow-md focus:shadow-lg text-black caret-black resize-vertical';
  ...
  return (
    <div className="space-y-2">
      ...
      <div className="relative group">
        {icon && (
          <div className="absolute top-4 left-4 flex items-start pointer-events-none transition-colors duration-300 group-focus-within:text-blue-500">
            {icon}
          </div>
        )}
        <textarea
